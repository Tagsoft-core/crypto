                ...
                <div class="grid">
                    <div class="grid-body">
                        ...
                        <div class="d-flex flex-row mt-4 mb-4">
                            <a href="{{route('admin.withdraw', $wallet->slug)}}" class="btn btn-outline-light text-gray component-flat w-50 mr-2" type="button">WITHDRAW</a>
                            <a href="{{route('admin.deposit', $wallet->slug )}}" class="btn btn-primary w-50 ml-2" type="button">DEPOSIT</a>
                        </div>
                        <div class="d-flex mt-5 mb-3">
                            <small class="mb-0 text-primary">Recent Transactions (3)</small>
                        </div>
                        @php
                            $i=1;
                        @endphp
